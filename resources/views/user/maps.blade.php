...
<div class="min-h-screen flex flex-col items-center justify-center text-start text-pink-primary">
    ...
    <div class="w-4/5">
        ...
        <div class="md:border-4 border-2 border-pink-secondary h-450 rounded-3xl hover:border-pink-primary duration-500">
        ...
        <p class="text-base mt-4 mb-40">Jalan Kalasan</p>
    </div>
</div>
@endsection